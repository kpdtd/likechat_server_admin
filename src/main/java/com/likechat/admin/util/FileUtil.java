 ...
 * 
 */
package com.likechat.admin.util;
...
import com.likechat.admin.persistence.po.Message;
import com.likechat.admin.persistence.po.Status;
...
public class FileUtil {
	...
	public static Message uploadFile(HttpServletRequest request, HttpServletResponse response,
			String serverPath,String inputName) throws Exception {
		LogFactory.getInstance().getVideoContentManagerLogger().error("上传文件开始");
		Message msg = null;
		MultipartHttpServletRequest multipartRequest = (MultipartHttpServletRequest) request;
		CommonsMultipartFile file = (CommonsMultipartFile) multipartRequest.getFile(inputName);
		if(file == null || StringUtils.isBlank(file.getFileItem().getName())){
			msg = new Message();
		...
		String fileExt = null;
		String picFileName = file.getFileItem().getName();
		...
		String filePath = FileUtil.createFilePath(serverPath);
